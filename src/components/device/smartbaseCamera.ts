...
export default class SmartbaseCamera implements IIpDeviceManager {
  ...
  constructor(
    ...
    this.cameraDiscoveryEmitter = cameraDiscoveryEmitter;
  ...
  getBrightness() {
    return this.ipDevice.getBrightness();
  }

  getSaturation() {
    return this.ipDevice.getSaturation();
  }
  ...
  getUpgrader(): Promise<IDeviceUpgrader> {
    return createBoxfishUpgrader(this, this.cameraDiscoveryEmitter);
  }
