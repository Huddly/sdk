    ...
    describe('#start', () => {
        function mockSucessMessages(donePayload = {}) {
            ...
            dummyCameraManager.transport.on.withArgs('upgrader/status').callsArgWith(1, {
                payload: api_1.default.encode(Object.assign({ operation: 'done' }, donePayload))
            });
        }
        beforeEach(() => {
        ...
        describe('running hpk', () => {
            ...
            describe('watchdog', () => {
                it('should timeout if there no status message within 10s', () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        chai_1.expect(e).to.be.equal('Upgrading HPK: no status message within 10000');
                    }
                })).timeout(11000);
            });
